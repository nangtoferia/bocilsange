...
export const metadata: Metadata = {
    ...
    metadataBase: new URL("https://bocilsange.pages.dev"),
    alternates: {
        canonical: `/`,
    },
    openGraph: {
...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        "name": `${SITENAME}`,
        "description": `${SITENAME} Video Bokep Indo Jepang Jav Barat Simontok Viral Terbaru Bocil Ngentot Jilbab Smp Mama Sma korea china tante live paksa ngentot abg cewek pijat.`,
        "logo": "https://bocilsange.pages.dev/favicon.ico",
        "url": "https://bocilsange.pages.dev",
        "founder":{
            "@type":"Person",
            "name":"admin",
            "url":"https://bocilsange.pages.dev"
        ...
        "url": "https://bocilsange.pages.dev",
        "description": `${SITENAME} Video Bokep Indo Jepang Jav Barat Simontok Viral Terbaru Bocil Ngentot Jilbab Smp Mama Sma korea china tante live paksa ngentot abg cewek pijat.`,
        "image": "https://bocilsange.pages.dev/favicon.ico",
        "potentialAction":{
            "@type":"ReadAction",
            "target":"https://bocilsange.pages.dev"}
        }
        const jsonLd2 = {
            "@context": "https://schema.org",
        "@type": "WebSite",
        ...
        "potentialAction": { 
        "@type": "SearchAction", 
          "target": "https://bocilsange.pages.dev/?q={search_term}", 
